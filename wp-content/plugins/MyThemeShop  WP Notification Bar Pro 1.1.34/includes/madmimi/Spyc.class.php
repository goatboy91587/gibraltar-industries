 ...
 */
  public function load ($input) {
    return $this->_spyc_loadString($input);
  }
 ...
 */
  ...
  public static function YAMLLoadString($input) {
    $Spyc = new Spyc;
    return $Spyc->_spyc_loadString($input);
  }
...
// LOADING FUNCTIONS
  ...
  private function _spyc_load($input) {
    $Source = $this->loadFromSource($input);
    return $this->loadWithSource($Source);
  }

  private function _spyc_loadString($input) {
