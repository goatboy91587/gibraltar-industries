<?php
abstract class viewGrs extends baseObjectGrs {
    /* 
     * @deprecated
     */
    protected $_tpl = GRS_DEFAULT;
    /*
	...
	public function getPath($tpl) {
		$path = '';
		$parentModule = frameGrs::_()->getModule( $this->_code );
	...
	public function getModel($code = '') {
		return frameGrs::_()->getModule( $this->_code )->getController()->getModel($code);
	}
