<?php
class userGrs extends moduleGrs {
    ...
    public function isAdmin() {
        ...
        return current_user_can( frameGrs::_()->getModule('adminmenu')->getMainCap() );
    }
	...
	protected function _loadUserData() {
		if(!$this->_dataLoaded) {
			if(!function_exists('wp_get_current_user')) frameGrs::_()->loadPlugins();
	...
	public function getAdminsList() {
		global $wpdb;
		$admins = dbGrs::get('SELECT * FROM #__users 
